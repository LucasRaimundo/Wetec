...
public class SolicitacaoDao {
	...
	public ArrayList<Solicitacao>mostrarCobol(){
		Connection con = Conexao.receberConexao();
		ArrayList<Solicitacao> solicitacao = new ArrayList<>();
		String sql = "select * from vendas where tecnologia = Cobol";
		PreparedStatement preparador;
		try {
			preparador = con.prepareStatement(sql);
			ResultSet resultado = preparador.executeQuery();
	...
	public ArrayList<Solicitacao>mostrarLua(){
		Connection con = Conexao.receberConexao();
		ArrayList<Solicitacao> solicitacao = new ArrayList<>();
		String sql = "select * from vendas where tecnologia = lua";
		PreparedStatement preparador;
		try {
			preparador = con.prepareStatement(sql);
			ResultSet resultado = preparador.executeQuery();
